...
export default function Header({ returnBtn }) {
	...
	return (
		<header className=" lg:justify-center lg:items-center flex justify-between items-center px-[1.5rem] py-[.75rem] border-b border-[#D7D7D7] font-figtree md:px-[3.12rem]">
